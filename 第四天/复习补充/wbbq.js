...
$(function () {
    ...
    $faceDiv.appendTo(".insertFace").hide().css({
        left:$(".insertFace").offsetLeft+"px",
        top:$(".insertFace").offsetTop+16+"px"
    ...
    var str1="<div class='showFace'>";
    for(var ke in friendsList){
        str1+="<a href='javascript:;'title='"+friendsList[ke]+"'>"+friendsList[ke]+"</a><br>";
    }
    str1+="</div>";

    var $faceDiv1=$(str1);
    $faceDiv1.appendTo(".creatNew").hide().css({
        left:$(".creatNew").offsetLeft+"px",
        top:$(".creatNew").offsetTop+16+"px",
        width:30
